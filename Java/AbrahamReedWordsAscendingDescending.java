...
public class AbrahamReedWordsAscendingDescending 
{
    ...
    public static void main(String[] args) throws FileNotFoundException 
    {
        ...
        String file = "src/collection_of_words.txt";
        ...
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter("src/collection_of_words.txt"));
        ...
        try {
            BufferedWriter seconWriter = new BufferedWriter(new FileWriter("src/collection_of_words.txt"));
